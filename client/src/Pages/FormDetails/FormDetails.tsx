...
import Mob_Middle from "../../Assets/Images/mob_middle.png";
import Footer from "../../Assets/Images/Footer.png";
import Mob_Footer from "../../Assets/Images/mob_footer.png";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.middle}>
        {isMobile ? <img src={Mob_Middle} alt="" className={styles.img} /> : <img src={Middle} alt="" className={styles.img} />}
      </div>
      <div className={styles.footer}>
        {isMobile ? <img src={Mob_Footer} alt="" className={styles.img} /> : <img src={Footer} alt="" className={styles.img} />}
      </div>
    </div>
  );
}
